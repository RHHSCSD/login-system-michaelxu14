...
public class LoginFrame extends javax.swing.JFrame {
     ...
     */
    public LoginFrame(RegistrationSystem registrationSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Authentication token");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<User> users = registrationSystem.loadUsers();
        ...
        for (User user : users) {
            if (user.getEmail().equals(email)) {
                // If the email matches, retrieve the authToken
        ...
        // Perform authentication
            if (registrationSystem.authenticate(email, password, authToken)) {
